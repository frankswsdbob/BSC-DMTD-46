...
2. Enter 'npm install' to complete the model
3. Enter 'node server.js' to start the API server, the default port is 3001.
4. Enter the messenger-app folder
...
3. You can open two browser tabs at the same time to have a real-time conversation.
